...
\wg{how do we argue this function to be holomorphic?}
...
That is, a there could be multiple conjugacy classes of $PGL_2(\C)$
...
\wg{hmmm this does not seem to be helping much.}
...
Note that we can represent rational functions as matrices with the
